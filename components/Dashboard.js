          ...
          <li className="aside_list-item">
            <details>
              ...
              <div className="reportes">
                <Link href="/dashboard/list" ><h4 className="reporte">Reporte Ventas</h4></Link>
                <Link href="" ><h4 className="reporte">Reporte Almacen</h4></Link>
                <Link href=""><h4 className="reporte">Reporte Compras</h4></Link>
              </div>
